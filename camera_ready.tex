...
%TODO: update this figure (change out task efficiency bars with total task efficiency, fix error in subjective graph, add std error bars and significance levels)
\begin{figure*}
